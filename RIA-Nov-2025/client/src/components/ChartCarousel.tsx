    ...
    <div className="relative w-full h-full group">
      ...
      <div className="absolute top-1/2 -translate-y-1/2 left-0 z-10 pointer-events-none">
        <Button
            ...
            variant="default"
            size="icon"
            className={`pointer-events-auto !absolute hidden md:flex left-2 md:-left-8 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white text-primary shadow-lg z-10 h-12 w-12 rounded-full ${currentIndex === 0 ? 'opacity-50 cursor-not-allowed' : ''}`}
      ...
      <div className="absolute top-1/2 -translate-y-1/2 right-0 z-10 pointer-events-none">
        <Button
            ...
            variant="default"
            size="icon"
            className={`pointer-events-auto !absolute hidden md:flex right-2 md:-right-8 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white text-primary shadow-lg z-10 h-12 w-12 rounded-full ${currentIndex === totalSlides - 1 ? 'opacity-50 cursor-not-allowed' : ''}`}
