      ...
      return (
        <div className="bg-background/95 backdrop-blur-sm p-3 border border-border rounded-lg shadow-md">
          ...
          <div className="space-y-1">
            <p className="text-[#2563eb] font-semibold font-heading text-sm" style={{ color: 'hsl(var(--chart-3))' }}>
              {`Current Advisor: ${formatFullCurrency(currentAdvisorValue)}`}
            </p>
            <p className="text-[#76a923] font-semibold font-heading text-sm" style={{ color: 'hsl(var(--chart-2))' }}>
              {`Flat Fee: ${formatFullCurrency(flatFeeValue)}`}
            </p>
            <p className="text-destructive font-semibold font-heading text-sm">
    ...
    return (
      <div className="bg-transparent dark:bg-transparent backdrop-blur-sm p-3 border border-popover-border rounded-lg shadow-md">
        ...
        <div className="space-y-1">
          ...
          <p className="text-[#76a923] font-semibold font-heading text-sm border-t border-border pt-1 mt-1" style={{ color: 'hsl(var(--primary))' }}>
        ...
        >
          ...
          */}
          ...
          <Area
            ...
            dot={false}
            activeDot={{ r: 6, fill: 'hsl(var(--chart-3))', stroke: '#ffffff', strokeWidth: 2 }}
          ...
          */}
          <Area
            ...
            dot={false}
            activeDot={{ r: viewMode === 'spending' ? 6 : 8, fill: 'hsl(var(--chart-2))', stroke: '#ffffff', strokeWidth: 2 }}
            animationDuration={1000}
          />
